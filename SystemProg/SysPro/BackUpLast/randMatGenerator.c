...
#define  LOG_FILE        "MatInverserModule.log"
...
int main(int argc, char *argv[]){
	...
	for(i = 0; i < threadNumber; i++){      /* create numthreads computethreads */  
    ...
    for (i = 0; i < threadNumber ; i++)    /* wait for computethreads to be done */
